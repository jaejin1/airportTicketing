...
<div class="findMemberId">
		...
		<p class="findId_info">비밀번호 찾기 </p>
		<div class="findId_label">
			<p class="findId">회원가입 당시 입력한 ID와 이름과 E-메일 주소로 일치하는 계정을 찾습니다.</p>

			<form action="./findMemberpw.php"  method="post" name="form">
        <div>
        <label class="label_stwid65">ID</label><input type="text" id="id" name="id" style="width:383px;" title="아이디를 입력하세요.">
      </div>
        <div>
        ...
        <br/>
          <div class="find_btn">
            <input type="submit" class="btn_idsh" value="비밀번호 찾기">
          </div>
